...
func NewChtIndexer(db abeydb.Database, odr OdrBackend, size, confirms uint64) *snailchain.ChainIndexer {
	...
	return snailchain.NewChainIndexer(db, abeydb.NewTable(db, "chtIndex-"), backend, size, confirms, time.Millisecond*100, "cht")
}
